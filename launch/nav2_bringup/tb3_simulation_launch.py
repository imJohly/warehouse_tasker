...
def generate_launch_description():
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            bringup_dir, 'map', 'map_1715820556.yaml'),
    ...
    declare_world_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(bringup_dir, 'worlds', 'warehouse_world.world'),
    ...
    rviz_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(launch_dir, 'rviz_launch_alternate.py')),
    ...
    bringup_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(launch_dir, 'bringup_launch_alternate.py')),
