...
def generate_launch_description():
    ...
    robots = [
        {'name': 'tb1', 'x_pose': 0.0, 'y_pose': 0.5, 'z_pose': 0.01},
        {'name': 'tb2', 'x_pose': 0.0, 'y_pose': -0.5, 'z_pose': 0.01}]
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=os.path.join(bringup_dir, 'map', 'map_1715820556.yaml'),
        description='Full path to map file to load')

    declare_tb1_params_file_cmd = DeclareLaunchArgument(
        'tb1_params_file',
        default_value=os.path.join(bringup_dir, 'params', 'nav2_multirobot_params_1.yaml'),
        description='Full path to the ROS2 parameters file to use for robot1 launched nodes')

    declare_tb2_params_file_cmd = DeclareLaunchArgument(
        'tb2_params_file',
    ...
    ld.add_action(declare_tb1_params_file_cmd)
    ld.add_action(declare_tb2_params_file_cmd)
